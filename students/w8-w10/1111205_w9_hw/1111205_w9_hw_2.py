...
model.add(tf.keras.layers.Dense(units=64, input_dim=512,  kernel_initializer='normal',activation=activation_function, name='layers_dense2'))
model.add(tf.keras.layers.Dense(units=64, input_dim=10,  kernel_initializer='normal',activation=activation_function, name='layers_dense3')) 
# Add output layer
...
if use_mse:
    ...
    train_history = model.fit(x=x_train_2D, y=y_train_one_hot, validation_split=0.2, epochs=epoch_num, batch_size=100, 
